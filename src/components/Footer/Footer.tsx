          ...
          <div className={s.footer__column}>
            <div className={s.footer__menu}>
              <ul className={s.footer__list}>
                <li><a href="" className={s.footer__link}>Про нас</a></li>
                <li><a href="" className={s.footer__link}>Проєкти</a></li>
                <li><a href="" className={s.footer__link}>Учасники</a></li>
                <li><a href="" className={s.footer__link}>Гранти</a></li>
                <li><a href="" className={s.footer__link}>ГО</a></li>
                <li><a href="" className={s.footer__link}>Вакансії у громадському секторі</a></li>
                <li><a href="" className={s.footer__link}>Контакти</a></li>
              </ul>
            </div>
          </div>
          <div className={s.footer__column}>
            <div className={s.footer__item}>
              ...
              <div className={s.footer__button}>
                <a href="" className={s.footer__btn}>Підтримати проєкт</a>
              </div>
              <div className={s.footer__contact}>
                <div className={s.footer__phoneContact}><span>+38 096 016 59 07</span></div>
                <div className={s.footer__emailContacts}><span>active.people.city@gmail.com</span></div>
              </div>

            </div>
          </div>
        </div>
        <div className={s.footer__copy}>Розробка <a href="https://baza-trainee.tech/ua">Baza Trainee Ukraine </a>  © Усі права захищені</div>
      </div>
    </footer>
  )
}
