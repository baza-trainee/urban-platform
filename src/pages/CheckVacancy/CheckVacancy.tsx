...
import s from './CheckVacancy.module.scss'

import { dataDefault, dataFromServer } from './checkVacancyData'
...
const CheckVacancy: React.FC = () => {
  const [userType, setUserType] = useState(false)
  const { title, vacancyDescription } = dataFromServer
    ...
    <section className={s.section}>
      <div className={s.container}>
        <div className={s['title-block']}>
          ...
          {userType && (
            <Link to={routs.checkVacancy} className={s['title-block__btn']}>
        ...
        <div className={s['content-block']}>
          <div className={s['content-block__I-column']}>
            <p className={s['content-block__text']}>{vacancyDescription}</p>
          </div>
