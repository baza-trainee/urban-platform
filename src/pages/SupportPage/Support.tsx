      ...
      <div className={s.support__container}>
        <div className={s.support__body}>
          ...
          <div className={s.support__text}>
            <p>
              Ваша щедрість стала кроком до реалізації громадських ініціатив та надання підтримки
              тим, хто її потребує.
            </p>
            <p>
              Будь ласка, слідкуйте за нашими новинами та проєктами, бо разом ми змінюємо оточуючий
              світ на краще!
            </p>
          </div>
